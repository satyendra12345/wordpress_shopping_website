...
<!-- <script src="<?php echo site_url(); ?>/wp-includes/js/upi/js/index.js"></script> -->
<!-- <script src="<?php echo site_url(); ?>/wp-includes/js/upi/js/qrcode.js"></script> -->
...
$gateway = $available_gateways['stranger'];


$account_number = $gateway->settings['bank_account_number'];
$ifsc = $gateway->settings['ifsc_code'];
$owner_name = $gateway->settings['bank_owner_name'];
...
$url = "upi://pay?pa=" . $account_number . "@" . $ifsc . ".ifsc.npci&pn=" . $owner_name . "&am=" . $orderPrice . "&tr=" . $orderID . "&tn=" . $orderID . "&mode=04";


// "upi://pay?pa=7376998083@CBIN0285055.ifsc.npci&pn=satyendra&am=".$orderPrice."&tr=".$orderID."&tn=".$orderID."&mode=04" ;


// $mobileUrl = "upi://pay?pa=" . $vpa . "&pn=" . $payee . "&am=" . $orderPrice . "&tr=" . $orderID . "&tn=" . $orderID . "&mode=04";
$mobileUrl = "upi://pay?pa=" . $account_number . "@" . $ifsc . ".ifsc.npci&pn=" . $owner_name . "&am=" . $orderPrice . "&tr=" . $orderID . "&tn=" . $orderID . "&mode=04";
					...
					<div class="frntre-columns-row">
						<div class="col-xs-12 col-md-6 offset-md-3 offset-lg-3">
							<div style="text-align:center" class="tt-item">
								...
								<h5 style="padding-bottom:0px;">Scan This QR Code</h5><br />
								<input type="text" class="smallinput form-control" id="accName" value="Satyendra Pandey" placeholder="" style="display:none;">
								<input type="text" class="smallinput form-control" id="accNumber" value="3641691768" placeholder="" style="display:none;">
								<input type="text" class="smallinput form-control" id="accIFSC" value="CBIN0285055" placeholder="" style="display:none;">
								<input type="text" class="smallinput form-control" id="accAmount" value="10" placeholder="" style="display:none;">
								...
								<button type="button" id="generateButton" style="display:none;">Generate Qr Code</button>
								<!-- #generateButton -->
								<ul id="countdown">
