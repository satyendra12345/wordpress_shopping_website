...
$day_next_day				= date('jS M', strtotime(date('l') . " +1 days"));
$day_next_next 				= date('D', strtotime(date('l') . " +2 days"));
$day_next_next_day 			= date('jS M', strtotime(date('l') . " +2 days"));
$day_next_next_next 		= date('D', strtotime(date('l') . " +3 days"));
$day_next_next_next_day 	= date('jS M', strtotime(date('l') . " +3 days"));
										...
										<?php if ( $current_hour < 12 ): ?>
											<div class="row available-slots">
												<div class="col-xl-4 col-md-6 col-sm-12">
													<div class="wrapper active-checkout-box">
														...
														<!-- <label for="Tomorrow_<?php echo $day_next_day ?>">
															...
															<input type="radio" id="Tomorrow_<?php echo $day_next_day ?>" name="available_delivery_slot" value="Tomorrow <?php echo $day_next_day ?> 06AM - 09PM" checked>
															<div class="content">
																<h6>Tomorrow <?php echo $day_next_day ?></h6>
																<span>06AM - 09PM</span>
															</div>
												...
												<div class="col-xl-4 col-md-6 col-sm-12">
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_day ?>1">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_day ?>1" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 06AM - 09PM">
															<div class="content">
													...
													<div class="wrapper">
														<div class="custom-control custom-radio">
															<input id="Tomorrow_<?php echo $day_next_next_day ?>1" type="radio" class="input-radio custom-control-input" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 06AM - 09PM" />
												...
												<div class="col-xl-4 col-md-6 col-sm-12">
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_day ?>2">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_day ?>2" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 10AM - 12PM">
															<div class="content">
																<h6><?php echo $day_next_next ?> <?php echo $day_next_next_day ?></h6>
																<span>10AM - 12PM</span>
															</div>
													...
													<div class="wrapper">
														<div class="custom-control custom-radio">
															<input id="Tomorrow_<?php echo $day_next_next_day ?>2" type="radio" class="input-radio custom-control-input" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 10AM - 12PM" />
												...
												<div class="wrapper">
													...
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_day ?>3">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_day ?>3" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 06PM - 09PM">
															<div class="content">
																<h6><?php echo $day_next_next ?> <?php echo $day_next_next_day ?></h6>
																<span>06PM - 09PM</span>
															</div>
											...
											<div class="row available-slots">
												<div class="col-xl-4 col-md-6 col-sm-6">
													<div class="wrapper active-checkout-box">
														...
														<!-- <label for="Tomorrow_<?php echo $day_next_day ?>">
															<input type="radio" id="Tomorrow_<?php echo $day_next_day ?>" name="available_delivery_slot" value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 06AM - 09PM" checked>
															<div class="content">
																<h6><?php echo $day_next_next ?> <?php echo $day_next_next_day ?></h6>
																<span>06AM - 09PM</span>
															</div>
												...
												<div class="col-xl-4 col-md-6 col-sm-6">
													<div class="wrapper">
														<div class="custom-control custom-radio">
															...
															class="input-radio custom-control-input" 
															name="available_delivery_slot" 
															value="<?php echo $day_next_next ?> <?php echo $day_next_next_day ?> 10AM - 12PM" />
												...
												<div class="col-xl-4 col-md-6 col-sm-6">
													<div class="wrapper">
														<div class="custom-control custom-radio">
															...
															<input id="Tomorrow_<?php echo $day_next_next_next_day ?>3" 
															type="radio" 
															class="input-radio custom-control-input" 
															name="available_delivery_slot" 
															value="<?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?> 06AM - 09PM" />

															<label 
															for="Tomorrow_<?php echo $day_next_next_next_day ?>3" 
															class="custom-control-label">
																<div class="content">
													...
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_next_day ?>3">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_next_day ?>3" name="available_delivery_slot">
															<div class="content">
																<h6><?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?></h6>
																<span>06AM - 09PM</span>
															</div>
												...
												<div class="col-xl-4 col-md-6 col-sm-6">
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_next_day ?>4">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_next_day ?>4" name="available_delivery_slot" value="<?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?> 10AM - 12PM">
															<div class="content">
																<h6><?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?></h6>
																<span>10AM - 12PM</span>
															</div>
													...
													<div class="wrapper">
														<div class="custom-control custom-radio">
															...
															class="input-radio custom-control-input" 
															name="available_delivery_slot" 
															value="<?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?> 10AM - 12PM" />
												...
												<div class="col-xl-4 col-md-6 col-sm-6">
													<!-- <div class="wrapper">
														<label for="Tomorrow_<?php echo $day_next_next_next_day ?>5">
															<input type="radio" id="Tomorrow_<?php echo $day_next_next_next_day ?>5" name="available_delivery_slot" value="<?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?> 06PM - 09PM">
															<div class="content">
																<h6><?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?></h6>
																<span>06PM - 09PM</span>
															</div>
													...
													<div class="wrapper">
														<div class="custom-control custom-radio">
															...
															class="input-radio custom-control-input" 
															name="available_delivery_slot" 
															value="<?php echo $day_next_next_next ?> <?php echo $day_next_next_next_day ?> 06PM - 09PM" />
