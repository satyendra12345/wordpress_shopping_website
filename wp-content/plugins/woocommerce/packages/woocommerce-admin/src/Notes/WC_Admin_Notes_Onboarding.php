...
class WC_Admin_Notes_Onboarding {
	...
	public static function add_task_list_complete_note() {
		...
		$note->set_title( __( 'Congratulations - your store is ready for launch!', 'woocommerce' ) );
		$note->set_content( __( 'You’re ready to take your first order - may the sales roll in!', 'woocommerce' ) );
		...
		$note->add_action(
			'market-store',
			__( 'Market my store', 'woocommerce' ),
