...
if (\PHP_VERSION_ID > 50300) {
    ...
    $bootstrap = new \FSVendor\WPDesk\Plugin\Flow\PluginBootstrap($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, $requirements, $product_id, $plugin_init_factory);
    $bootstrap->run();
