 ...
 */
class ElasticSearchHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * @var Client
     */
     ...
     */
    public function __construct(\FSVendor\Elastica\Client $client, array $options = array(), $level = \FSVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
