 ...
 */
class NormalizerFormatter implements \FSVendor\Monolog\Formatter\FormatterInterface
{
    ...
    protected function normalize($data, $depth = 0)
    {
        ...
        if (\is_object($data)) {
            ...
            return \sprintf("[object] (%s: %s)", \FSVendor\Monolog\Utils::getClass($data), $value);
        }
        if (\is_resource($data)) {
