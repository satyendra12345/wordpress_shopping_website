 ...
 */
class SlackbotHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FSVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
