 ...
 */
class CubeHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($url, $level = \FSVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    protected function connectUdp()
    {
        if (!\extension_loaded('sockets')) {
            throw new \FSVendor\Monolog\Handler\MissingExtensionException('The sockets extension is required to use udp URLs with the CubeHandler');
        }
    ...
    private function writeHttp($data)
    {
        ...
        \FSVendor\Monolog\Handler\Curl\Util::execute($this->httpConnection, 5, \false);
    }
}
