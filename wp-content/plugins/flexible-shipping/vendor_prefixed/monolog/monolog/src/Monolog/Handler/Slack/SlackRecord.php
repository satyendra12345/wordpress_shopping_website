...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \FSVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FSVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \FSVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \FSVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \FSVendor\Monolog\Logger::INFO:
