 ...
 */
class NewRelicHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($level = \FSVendor\Monolog\Logger::ERROR, $bubble = \true, $appName = null, $explodeArrays = \false, $transactionName = null)
    {
    ...
    protected function write(array $record)
    {
        if (!$this->isNewRelicEnabled()) {
            throw new \FSVendor\Monolog\Handler\MissingExtensionException('The newrelic PHP extension is required to use the NewRelicHandler');
        }
