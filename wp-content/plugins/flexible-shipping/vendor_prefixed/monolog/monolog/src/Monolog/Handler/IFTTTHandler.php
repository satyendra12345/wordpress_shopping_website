 ...
 */
class IFTTTHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $eventName;
    private $secretKey;
    /**
     ...
     */
    public function __construct($eventName, $secretKey, $level = \FSVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
