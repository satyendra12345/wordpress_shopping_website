 ...
 */
class CouchDBHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = array(), $level = \FSVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
