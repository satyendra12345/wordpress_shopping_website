...
class DeduplicationHandler extends \FSVendor\Monolog\Handler\BufferHandler
{
     ...
     */
    public function __construct(\FSVendor\Monolog\Handler\HandlerInterface $handler, $deduplicationStore = null, $deduplicationLevel = \FSVendor\Monolog\Logger::ERROR, $time = 60, $bubble = \true)
    {
