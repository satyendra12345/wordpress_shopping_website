 ...
 */
class BrowserConsoleHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FSVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
