 ...
 */
class BufferHandler extends \FSVendor\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\FSVendor\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \FSVendor\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
