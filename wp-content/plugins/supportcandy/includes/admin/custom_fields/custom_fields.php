...
<div class="bootstrap-iso">
  ...
  <h3>
    <?php _e('Custom Fields','supportcandy');?>
  ...
  <div class="row" style="margin-bottom:20px;">
    <ul class="nav nav-pills wpsc_setting_pills">
      <li id="wpsc_ticket_custom_fields" role="presentation" class="active"><a href="javascript:wpsc_get_ticket_form_fields();"><?php _e('Ticket Form Fields','supportcandy');?></a></li>
      <li id="wpsc_agentonly_fields" role="presentation"><a href="javascript:wpsc_get_agentonly_fields();"><?php _e('Agent Only Fields','supportcandy');?></a></li>
