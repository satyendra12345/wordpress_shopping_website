...
if($enable_login_settings=='1') {?>
		...
		<form id="frm_wpsc_sign_in" action="javascript:wpsc_sign_in();" method="post" style="margin-bottom:5px;">
			...
			<button id="wpsc_sign_in_btn" class="btn btn-lg btn-block" type="submit" style="<?php echo $signin_button_css ?>"><?php _e('Please sign in to raise a new request','supportcandy')?></button>
	...
	<?php 		
		...
		?>	
		<input class="btn btn-lg btn-block" type="button" id="wpsc_login_link" onclick="window.location.href='<?php echo $login_url; ?>'" value="<?php _e('Please sign in to raise a new request','supportcandy');?>" style="margin-top:80px; margin-bottom: 5px; <?php echo $signin_button_css ?>"/>
		<?php
}
