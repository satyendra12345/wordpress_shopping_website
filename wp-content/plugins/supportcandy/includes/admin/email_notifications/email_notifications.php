...
<div class="bootstrap-iso">
  ...
  <h3>
    <?php _e('Email Notifications','supportcandy');?>
  ...
  <div class="row" style="margin-bottom:20px;">
    <ul class="nav nav-pills wpsc_setting_pills">
      <li id="wpsc_en_setting_general" role="presentation" class="active"><a href="javascript:wpsc_get_en_general_setting();"><?php _e('General Settings','supportcandy');?></a></li>
      <li id="wpsc_en_ticket_notifications" role="presentation"><a href="javascript:wpsc_get_en_ticket_notifications();"><?php _e('Ticket Notifications','supportcandy');?></a></li>
...
function wpsc_page_inline_script(){
  ...
  <?php
  do_action('wpsc_add_external_en_setting_scripts');
}
