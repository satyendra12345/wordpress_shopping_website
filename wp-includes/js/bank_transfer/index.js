...
function genQrCode() {
  console.log("generatin errof")
 var accName = $("#accName").val();
 var accNumber = $("#accNumber").val();
 var accIFSC = $("#accIFSC").val();
 var am=$("#accAmount").val(); 
//  var accName = "satyendra";
//  var accNumber = "3641691768";
//  var accIFSC = "CBIN0285055";
 

  //TODO - Show Error on empty Box.
  console.log(accName, accNumber, accIFSC);
  var str = "upi://pay?pa=" + accNumber + "@" + accIFSC +".ifsc.npci&pn=" + accName + "&cu=INR&am="+am;
